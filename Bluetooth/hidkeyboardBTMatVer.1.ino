...
int rpflag = 0;
int lastrpflag = 0;
int limit = 880; // Force Sensing Resistor - 0-1000 lower = more sensitive
...
if(lpflag != lastlpflag)
  {
  Serial.print("\nSending ");
  Serial.println("Left Button Has Been Pushed");
  stringOne = "a";
  //stringOne = "KEY_LEFT_ARROW";
  ble.print("AT+BleKeyboard=");
  ble.println(stringOne);
...
if(rpflag != lastrpflag)
  {
  Serial.print("\nSending ");
  Serial.println("Right Button Has Been Pushed");
  lastrpflag = rpflag;
  stringOne = "b";
 ...
 //adafruit 
  ...
  Serial.print("\nSending ");
  Serial.println("lol");//keys

  ble.print("AT+BleKeyboard=");
  ble.println("lol");//keys
